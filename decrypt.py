...
#!/usr/bin/env python3
"""
Decryption script with hardcoded key and salt that decrypts data generated by encrypt.py.
...
# Hardcoded key and salt (these should match what was used for encryption)
HARDCODED_KEY = "djvlwviwreurvbiebvlwejvw424234dwuihi1081hvbefi"
HARDCODED_SALT = "sadmkjsnkwefcweicwhcowedcndocnwnd4380234734723"
...
def main():
    ...
    print(f"Hardcoded Salt: {HARDCODED_SALT}")
    print()
    ...
    try:
        # Decrypt the data
        decrypted_passphrase = decrypt_passphrase(encrypted_input, HARDCODED_KEY, HARDCODED_SALT)
